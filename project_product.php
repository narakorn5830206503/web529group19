...
$menufile="gs://$appid/project_nikon1.txt";
...
echo "<li $active><a href='project_nikon.php?p=$key'>$icon $value</a>";
}
}
...
echo "<li $active><a href= project_nikon.php?p=edit&file=project_nikon1.txt'>Edit Menu</a>";
}
?>
</ul>